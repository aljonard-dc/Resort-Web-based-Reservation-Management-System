...
$sql = "SELECT * FROM information_details WHERE id='$id' ORDER BY client_id DESC LIMIT 1";
...
<?php include('./header_authenticated.php') ?> 
    ...
    <p class="typing-text" style="width: fit-content; margin:auto;"><i class="fa-solid fa-comment-dots"></i>&nbsp;Could you provide the following personal information?</p>
        ...
        <form action="clientinfo_step1_updateSubmit.php" method="post">
...
<input type="text" id="lname" name="lastname" value="<?php echo htmlspecialchars($last_name); ?>" required>

<label for="fname">First Name:</label>
<input type="text" id="fname" name="firstname" value="<?php echo htmlspecialchars($first_name); ?>" required>

<label for="mname">Middle Name:</label>
<input type="text" id="mname" name="middlename" value="<?php echo htmlspecialchars($middle_name); ?>">

<label for="age">Age:</label>
    <input type="text" id="ageInput" name="age" value="<?php echo $_SESSION['age_session']; ?>" required pattern="[0-9]{2}"  maxlength="2" oninput="validateAge()">
    <span id="age-error" style="color: red;"></span> 

<label for="contact">Contact Number:</label>
<input type="text" id="contact" name="contactnumber" value="<?php echo htmlspecialchars($contact_number); ?>" required pattern="[0-9]{11}" title="Please enter a valid 11-digit phone number" maxlength="11" oninput="validateContactNumber()" required>
<span id="contactnumber-error" style="color: red;margin-bottom:10px;"></span>
<label for="address">Address:</label>
<input type="text" id="address" name="address" value="<?php echo htmlspecialchars($address); ?>" required>

<label for="email">Email Address:</label>
<input type="email" id="email" name="emailaddress" value="<?php echo htmlspecialchars($email_address); ?>" required>

    <div class="button-container">

        <input type="button" value="Clear All" id="clear-button">

           <input type="submit" value="Next" id="submit-button" onclick="checkContactNumber(); checkAge();">
    ...
    form.addEventListener("submit", function (event) {
        if (!emailInput.checkValidity() || !contactInput.checkValidity()) {
            event.preventDefault(); // Prevent form submission if the email or contact number is invalid.
        }
    });
...
function checkAge() {
    ...
    if (age.length === 2) {
        ...
        ageError.textContent = 'Age must be 2 digits.';
    }
}
